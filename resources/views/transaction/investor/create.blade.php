    ...
    <div class="box-body">
    	<div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <label for="image" class="control-label">Identity Card Photo</label>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <label for="image" class="control-label">Taxpayer Registration Number Photo</label>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('bank_id', [''=>'- Select -']+$bank, null, ['class'=>'form-control', 'id'=>'bank_id']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('acc_name', null, ['class'=>'form-control', 'id'=>'acc_name']) !!}
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="dummy" class="control-label">Is Dummy?</label>
                        {!! Form::select('dummy', [''=>'Choose', 1=>'Yes', 0=>'No'], null, ['class'=>'form-control','id'=>'dummy']); !!}
                        @if($errors->has('dummy'))
                            <span class="invalid-feedback" role="alert">
                                {{ $errors->first('dummy') }}
                            </span>
