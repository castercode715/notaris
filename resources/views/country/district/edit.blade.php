...
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
			...
			<a href="/master/district/create" class="btn btn-success" title="Create">
...
@section('content')
    ...
    <div class="box box-solid" >
		...
		<div class="col-md-12" style="background-color:#fff;">
	        ...
	        <form action="/master/district/edit_district/{{$data->id}}" method="post" >
            @csrf
            <div class="box-body">
