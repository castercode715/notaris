...
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
            {{--<a href="{{ route('role.create') }}" class="btn btn-default"><i class="fa fa-plus"></i> Create</a>--}}
                ...
                @if (count($data))
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('role.edit', $item->id) }}"><i class="fa fa-edit"></i></a>
                                <a href="{{ route('role.destroy', $item->id) }}"><i class="fa fa-eraser"></i></a>
                            </td>
                        </tr>
                    @endforeach
                @else
