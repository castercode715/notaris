...
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
        	<a href="{{ route('privacy-policy.edit', $model->id) }}" class="btn btn-success" title="Edit Employee">
                <i class="fa fa-edit"></i> Update
            </a>
             {{-- onclick="return confirm('Anda yakin?')" --}}
            <a href="{{ route('privacy-policy.delete', $model->id) }}" class="btn btn-danger btn-delete2" title="Delete">
                <i class="fa fa-trash"></i> Delete
            </a>
        	<a href="{{ route('privacy-policy.create') }}" class="btn btn-success" title="Create Employee">
	...
	<div class="box-body">
		...
		<div class="row">
			<div class="col-md-6">
				<table class="table table-condensed table-striped">
					<tbody>
						...
						<tr>
							<th>Description</th>
							<td>{!! html_entity_decode($model->descr) !!}</td>
						</tr>
			...
			<div class="col-md-3">
				...
				@else
					<img src="/images/privacy-policy/{{ $model->image }}" class="img-responsive img-thumbnail">
				@endif
			</div>
		</div>
