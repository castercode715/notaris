...
@endphp
{!! Form::model($model, [
    'route' => $model->exists ? ['district.update', $model->id] : 'district.store',
    'method'=> $method,
]) !!}
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @if(!$model->exists)
                    {!! Form::select('mst_regencies', [''=>'- Select -'], null, ['class'=>'form-control', 'id'=>'mst_regencies', 'data-table'=>'mst_districts', 'data-key'=>'regencies_id',]) !!}
                @else
