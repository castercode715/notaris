...
@section('page_title') Edit About Us Description <i>({{ $language->language }})</i> @endsection
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
        	<a href="{{ route('about-us.show', base64_encode($model->about_us_id)) }}" class="btn btn-success" title="Detail">
...
<div class="box box-solid">
    {!! Form::model($model, [
        'route' => ['about-us.update-new', base64_encode($model->id) ],
        'method'=> 'put',
