...
@section('page_title') Edit About Us {{ $model->title }} @endsection
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
            <a href="{{ route('about-us.show', base64_encode($model->id)) }}" class="btn btn-success" title="Show">
...
<div class="box box-solid">
    {!! Form::model($model, [
        'route' => ['about-us.update', base64_encode($model->id)],
        'method'=> 'put'
    ]) !!}
    <div class="box-body">
        <div class="box-body">
