...
@section('page_title') Add Privacy Policy Description <i>({{ $language->language }})</i> @endsection
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
        	<a href="{{ route('privacy-policy.show', base64_encode($model->privacy_policy_id)) }}" class="btn btn-success" title="Detail Privacy Policy">
...
<div class="box box-solid">
    {!! Form::model($model, [
        'route' => 'privacy-policy.store-new',
        'method'=> 'post',
    ...
    <div class="box-body">
        <div class="box-body">
            ...
            {!! Form::hidden('privacy_policy_id', $id, []) !!}
