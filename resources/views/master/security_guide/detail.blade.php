...
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
            <a href="{{ route('security-guide.edit', base64_encode($model->id) ) }}" class="btn btn-success" title="Edit Security Guide">
                <i class="fa fa-edit"></i> Update
            </a>
            <a href="{{ route('security-guide.delete', base64_encode($model->id)) }}" class="btn btn-danger btn-delete2" title="Delete">
                <i class="fa fa-trash"></i> Delete
            </a>
            <a href="{{ route('security-guide.create') }}" class="btn btn-success" title="Create Security Guide">
        ...
        <div class="box-group" id="accordion">
            <div class="panel box box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ route('security-guide.edit-new', [base64_encode($model->security_guide_lang_id)]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a>
                    </div>
                </div>
                <div id="collapse1" class="panel-collapse collapse in">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                @if($model->image != '')
                                <img src="/images/security-guide/{{ $model->image }}" class="img-responsive">
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel box box-solid">
                <div class="box-header with-border">
                    ...
                    @if($data)
                    <div class="box-tools pull-right">
                        <a href="{{ route('security-guide.edit-new', [base64_encode($data->id)]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a>
                    </div>
                    @endif
                </div>
                <div id="collapse{{ $no }}" class="panel-collapse collapse">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                @if($data->image != '')
                                <img src="/images/security-guide/{{ $data->image }}" class="img-responsive">
                                @endif
                            </div>
                        </div>
                        @else
                        <p align="center">Please add description using this language</p>
                        <p align="center"><a href="{{ route('security-guide.create-new',[ base64_encode($model->id), $l->code]) }}" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> Add Description</a></p>
                        @endif
                    </div>
                </div>
            </div>
