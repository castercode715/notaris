...
@section('page_title') Edit Security Guide Description <i>({{ $language->language }})</i> @endsection
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
        	<a href="{{ route('security-guide.show', base64_encode($model->partner_id)) }}" class="btn btn-success" title="Detail">
...
<div class="box box-solid">
    {!! Form::model($model, [
        'route' => ['security-guide.update-new', base64_encode($model->id) ],
        'method'=> 'put',
