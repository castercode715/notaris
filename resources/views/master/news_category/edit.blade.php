...
@section('page_title') Edit News Category @endsection

@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
        	<a href="{{ route('news-category.show', base64_encode($model->id)) }}" class="btn btn-success" title="Detail">
                <i class="fa fa-search"></i> Detail
            </a>
            <a href="{{ route('news-category.delete', base64_encode($model->id)) }}" class="btn btn-danger btn-delete2" title="Delete">
                <i class="fa fa-trash"></i> Delete
            </a>
        	<a href="{{ route('news-category.create') }}" class="btn btn-success" title="Create">
...
<div class="box box-solid">
    {!! Form::model($model, [
        'route' => ['news-category.update', base64_encode($model->id)],
        'method'=> 'put'
    ]) !!}
