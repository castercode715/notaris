...
@section('page_title') Detail Help @endsection
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
        	<a href="{{ route('help.edit', base64_encode($model->id) ) }}" class="btn btn-success" title="Edit Help">
		...
		<div class="box-group" id="accordion">
			<div class="panel box box-solid">
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<a href="{{ route('help.edit-new', [base64_encode($model->help_lang_id)]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a>
					</div>
				</div>
				<div id="collapse1" class="panel-collapse collapse in">
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-6">
								@if($model->image != '')
								<img src="/images/help/{{ $model->image }}" class="img-responsive">
								@endif
							</div>
							<div class="col-md-6">
								{!! $model->iframe !!}
			...
			<div class="panel box box-solid">
				<div class="box-header with-border">
					...
					@if($data)
					<div class="box-tools pull-right">
						<a href="{{ route('help.edit-new', [base64_encode($data->id)]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a>
					</div>
					@endif
				</div>
				<div id="collapse{{ $no }}" class="panel-collapse collapse">
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-6">
								@if($data->image != '')
								<img src="/images/help/{{ $data->image }}" class="img-responsive">
								@endif
							</div>
							<div class="col-md-6">
								{!! $data->iframe !!}
						...
						<p align="center"><a href="{{ route('help.create-new',[ base64_encode($model->id), $l->code]) }}" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> Add Description</a></p>
						@endif
					</div>
				</div>
			</div>
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td>
								@if ($model->flag == 'faq') FAQ
								@elseif ($model->flag == 'how-to') HOW TO
								@endif
							</td>
						</tr>
						<tr>
