...
@section('page_title') Edit Help Description <i>({{ $language->language }})</i> @endsection
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
        	<a href="{{ route('help.show', base64_encode($model->help_id)) }}" class="btn btn-success" title="Detail Help">
                <i class="fa fa-search"></i> Detail
            </a>
            <a href="{{ route('help.index') }}" class="btn btn-success" title="Manage Help">
...
<div class="box box-solid">
    {!! Form::model($model, [
        'route' => ['help.update-new', base64_encode($model->id) ],
        'method'=> 'put',
