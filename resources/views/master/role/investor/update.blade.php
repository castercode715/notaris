...
<div class="box box-solid">
	{!! Form::model($model, [
	    'route' => ['investor.update', $model->id],
        'method'=> 'put',
	...
	<div class="box-body">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <input name="birth_date" type="text" value='{{$model->birth_date = date('d-m-Y', strtotime($model->birth_date))}}' class="form-control pull-right" id="datepicker">
                    </div>
        ...
        <div class="row">
        	<div class="col-md-4">
                <div class="form-group">
                    ...
                    <br>
                    <img style='width: 220px;height:210px;margin-bottom: 5px;' src="/images/investor/{{ $model->photo }}" class="img-responsive img-thumbnail">
        ...
        <div class='row'>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <img style='width: 220px;height:210px;margin-bottom: 5px;' src="/images/investor/foto_berkas/{{ $model->ktp_photo }}" class="img-responsive img-thumbnail">
        ...
        <div class='row'><div class="col-md-4">
                <div class="form-group">
                    <img style='width: 220px;height:210px;margin-bottom: 5px;' src="/images/investor/foto_berkas/{{ $model->npwp_photo }}" class="img-responsive img-thumbnail">
