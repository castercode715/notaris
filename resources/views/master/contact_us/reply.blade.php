...
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
            <a href="{{ route('inbox.index') }}" class="btn btn-success" title="Manage">
...
<div class="box box-solid">
        ...
        <div class="box-body" style="border: 1px solid #ddd; padding: 10px;">
    		<table class="table table-condensed">
    			<tr>
    				...
    				<td>{{ $model->investor->full_name }}</td>
    			</tr>
    			<tr>
    				<th>Send Date</th>
			...
			<div class="form-reply" style="display: none;">
				{!! Form::open(['route'=>'inbox.store','method'=>'post','enctype'=>'multipart/form-data']) !!}
    ...
    <div class="box-footer">
        <div class="box-header">
        	<h3 class="box-title">Previous Message</h3>
        </div>
        <div class="box-body">
